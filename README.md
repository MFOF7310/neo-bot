...
- `/play` — launch the AfriQuiz Activity right from a text channel (LAUNCH_ACTIVITY callback, no voice channel needed)
...
- `/play` — lance l'activité AfriQuiz depuis un salon texte (callback LAUNCH_ACTIVITY, sans salon vocal)

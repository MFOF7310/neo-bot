...
// user lang stmts
stmts.getUserLang = db.prepare('SELECT user_lang FROM scores WHERE user_id = ? AND guild_id = ?');
stmts.setUserLang = db.prepare('UPDATE scores SET user_lang = ? WHERE user_id = ? AND guild_id = ?');
